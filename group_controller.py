...
messages = controler.get_messages("5562981685163", '2025-03-01 00:00:00', '2025-04-15 23:59:59')

i = 0
"""
groups = controler.fetch_groups()
...
for group in groups:
    ...
    print(group.horario)
    print(group.enabled)
    print(group.is_links)
    print(group.is_names)
    print("")
